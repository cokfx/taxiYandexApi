	...
	if($_REQUEST['AJAX_CALL'] != 'Y'){
		...
		switch($arParams['NEED_JQUERY']){
			...
			case 'EXISTS_JQUERY' : 
				break;
			default:
				$APPLICATION->AddHeadScript('/bitrix/js/cab.misc/jquery-1.6.1.js');
		}

		$APPLICATION->AddHeadScript('/bitrix/js/cab.misc/radiobox/radiobox.js');
		$APPLICATION->AddHeadScript('/bitrix/js/cab.misc/checkbox/checkbox.js');
		$APPLICATION->AddHeadScript('/bitrix/js/cab.misc/cusel/js/cusel-2.5_1.js');
		$APPLICATION->AddHeadScript('/bitrix/js/cab.misc/cusel/js/cusel-multiple-0.9_1.js');
