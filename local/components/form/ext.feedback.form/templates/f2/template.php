...
if ($_REQUEST['strIMessagef1'] && $_REQUEST['eid']){
    ///home/c/cok23/caytex.ru/public_html/stream/form/loan-property-information
    header("Location: http://caytex.ru/stream/form/loan-property-information/?eid=".$_REQUEST['eid']);
}
...
<div class="feedback col-md-12" id="feedback<?= $arParams['COMPONENT_ID'] ?>">
    ...
    <form name="iblock_add"
          action="<?= $APPLICATION->GetCurPageParam("", array("strIMessage"), $get_index_page = false)//POST_FORM_ACTION_URI                             ?>"
          method="post" enctype="multipart/form-data">
        <?= bitrix_sessid_post() ?>
        <input type="hidden" name="component_id" value="<?= $arParams['COMPONENT_ID'] ?>">
        <input type="hidden" name="elem_id" value="<?= $elemIdTpl ?>">
        ...
        <div class="data-div">
            ...
            <? if (is_array($arResult["PROPERTY_LIST"]) && count($arResult["PROPERTY_LIST"] > 0)): ?>
                <div style="width: " class="col-md-1"></div>
                <div class="col-md-5">
                    <? $z_index = 100; ?>
                    ...
                    <? if ($rest!='Co'): ?>
                        <? if ($restBl!='Bl2'): ?>
                            ...
                            <div class="data col-md-12" id="<?= $propertyID ?>">
                                <div class="wrapper" style="z-index:<?= $z_index-- ?>">
                                    ...
                                    case "USER_TYPE":
                                        ...
                                        <div class="user-type">
                                            ...
                                            <input style="width: 40%;" class="form-control" value="<?= $value;?>" name=<?= "PROPERTY[" . $propertyID . "][" . $i . "][VALUE]"?> type="text" id="datepicker">
                                    ...
                                    ?>
                                    <input id="<?= $propertyID . '_' . $i ?>" class="inputtext form-control"
                                           type="password"
                            ...
                            <div class="row">
                                <? if ($propertyID == 'PROP_ID_ELEMENT'): ?>
                                <? else: ?>
                                    <div class="label <?= $arParams['DATA-div-LABEL-ALIGN-H'] ?> <?= $arParams['DATA-div-LABEL-ALIGN-V'] ?>">
                                ...
                                <? endif; ?>
                                <div class="data" id="<?= $propertyID ?>_CONFIRM">
                                    <input id="<?= $propertyID . '_CONFIRM_' . $i ?>" class="inputtext form-control"
                                           type="password"
                                           name="PROPERTY[<?= $propertyID ?>_CONFIRM][<?= $i ?>]" size="25"/>
                                    <?
                                    endif ?>
                                    <?
                                    } else { ?>
                                    ...
                                    case "F":
                                        for ($i = 0; $i < $inputNum; $i++) {
                                            ...
                                            ?>
                                            <input type="hidden"
                                                   name="PROPERTY[<?= $propertyID ?>][<?= $arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUED"] ? $arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE"] : $i ?>]"
                                                   value="<?= $value_id ?>"/>
                                            ...
                                            if (!empty($value) && is_array($arResult["ELEMENT_FILES"][$value])) {
                                                ...
                                                <label
                                                        for="file_delete_<?= $propertyID ?>_<?= $i ?>"><?= GetMessage("CT_EFBF_FORM_FILE_DELETE") ?></label>
                                                <br/>
                                                <?
                                                ...
                                                if ($arResult["ELEMENT_FILES"][$value]["IS_IMAGE"]) {
                                                    ...
                                                    ?>
                                                    <?= GetMessage("CT_EFBF_FORM_FILE_NAME") ?>: <?= $arResult["ELEMENT_FILES"][$value]["ORIGINAL_NAME"] ?>
                                                    <br/>
                                                    <?= GetMessage("CT_EFBF_FORM_FILE_SIZE") ?>: <?= $arResult["ELEMENT_FILES"][$value]["FILE_SIZE"] ?> b
                                                    <br/>
                                                    [
                                                    <a href="<?= $arResult["ELEMENT_FILES"][$value]["SRC"] ?>"><?= GetMessage("CT_EFBF_FORM_FILE_DOWNLOAD") ?></a>]
                                                    <br/>
                                                    <?
                                                }
                                            }
                                    ...
                                    case "G":
                                        ...
                                        ?>
                                        <select id="select_<?= $propertyID ?>" class="select form-control"
                                                name="PROPERTY[<?= $propertyID ?>]<?= $type == "multiselect" ? "[]\" size=\"" . $row_cnt . "\" multiple=\"multiple" : "" ?>">
                                            <?
                                        ...
                                        switch ($type):
                                            ...
                                            case "radio":
                                                if ($type == 'radio' && $arParams['LIST_NOT_ESTABLISHED_' . $propertyID] == 'Y'):?>
                                                    <input class="niceRadio" type="<?= $type ?>"
                                                           name="PROPERTY[<?= $propertyID ?>]<?= $type == "checkbox" ? "[" . $key . "]" : "" ?>"
                                                           value="" id="property_<?= $key ?>"/><label
                                                            for="property_<?= $key ?>"><?= GetMessage('CT_EFBF_NOT_ESTABLISHED') ?></label>
                                                    <br/>
                                                <?endif;
                                                ...
                                                foreach ($arResult["PROPERTY_LIST_FULL"][$propertyID]["ENUM"] as $key => $arEnum) {
                                                    ...
                                                    ?>
                                                    <input class="<?= $type == "checkbox" ? 'niceCheck' : 'niceRadio' ?>"
                                                           type="<?= $type ?>"
                                                           name="PROPERTY[<?= $propertyID ?>]<?= $type == "checkbox" ? "[" . $key . "]" : "" ?>"
                                                           value="<?= $key ?>"
                                            ...
                                            case "multiselect":
                                                ?>
                                                <select id="select_<?= $propertyID ?>" class="select"
                            ...
                            <? elseif ($restBl=='Bl2'):?>
                                ...
                                <div class="label row <?= $arParams['DATA-div-LABEL-ALIGN-H'] ?> <?= $arParams['DATA-div-LABEL-ALIGN-V'] ?>">
                                    ...
                                    <?if ($propertyID=="PROP_Present_Address_F2Bl2"):?>PROP_MAILING_ADDRESS_F2Bl3
                                        ...
                                        <div class="wrapper" style="z-index:<?= $z_index-- ?>">
                                            ...
                                            case "USER_TYPE":
                                                ...
                                                <div class="user-type">
                                                    ...
                                                    <input style="width: 40%;" class="form-control" value="<?= $value;?>" name=<?= "PROPERTY[" . $propertyID . "][" . $i . "][VALUE]"?> type="hidden" id="datepicker3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="data" id="<?= $propertyID ?>_CONFIRM">
                                            ...
                                            <?
                                                ...
                                                <? else: ?>
                                                    <?if($propertyID=='PROP_COPY_TO_MAILING_F2Bl2'):?>
                                                        <input id="<?= $propertyID . '_' . $i ?>"
                                                               class="step-action custom-button custom-button_blue"
                                                               type="button"
                    ...
                    <? if ($arParams["USE_CAPTCHA"] == "Y" && !$USER->IsAuthorized()): ?>
                            ...
                            <div class="data">
                                <div id="captcha_block">
                                    ...
                                    <? if ($arParams['USE_CAPTCHA_REFRESH']): ?>
                                        <a id="reload_captcha"
                                           href="javascript:void(0)"><?= GetMessage('CT_EFBF_RELOAD_CAPTCHA') ?></a>
                                    <? endif ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="label <?= $arParams['DATA-div-LABEL-ALIGN-H'] ?> <?= $arParams['DATA-div-LABEL-ALIGN-V'] ?>">
                                <?= !empty($arParams["CUSTOM_TITLE_CAPTCHA_INPUT"]) ? $arParams["CUSTOM_TITLE_CAPTCHA_INPUT"] : GetMessage("CT_EFBF_FORM_CAPTCHA_PROMPT") ?>
                                <span class="starrequired">*</span>:
                            </div>
                            <div class="data" id="CAPTCHA">
                                <div class="wrapper">
                                    <input class="inputtext form-control" type="text" name="captcha_word"
                                           maxlength="50"
                                           value="">
                ...
                <div class="col-md-5">
                    ...
                    <? if ($rest=='Co'): ?>
                        <div class="label row <?= $arParams['DATA-div-LABEL-ALIGN-H'] ?> <?= $arParams['DATA-div-LABEL-ALIGN-V'] ?>">
                            ...
                            <?if ($propertyID=='PROP_Present_Address_F2Bl2_Co'):?>
                                <div style="font-weight: 600;margin-top: 100px;"></div>
                                <p style="margin-top: 15px;margin-bottom: 5px;font-size: 14px">Co-Borrower</p>
                            <?elseif($propertyID=='PROP_COPY_TO_MAILING_F2Bl2_Co'):?>
                            <?else:?>
                                <?= $label; ?>
                            <?endif;?>
                                ...
                                <div class="wrapper" style="z-index:<?= $z_index-- ?>">
                                    ...
                                    case "USER_TYPE":
                                        ...
                                        <div class="user-type">
                                            ...
                                            <input style="width: 40%;" class="form-control" value="<?= $value;?>" name=<?= "PROPERTY[" . $propertyID . "][" . $i . "][VALUE]"?> type="text" id="datepicker1">
            ...
            <? endif ?>
                ...
                <div class="row">
                        ...
                        <div class="button-wrap btn btn-item">
                            ...
                            <input class="step-action custom-button custom-button_blue" type="button"
                                   name="efbf_submit"
                                   value="PREVIUS PAGE"/>
                            </a>
                        </div>
                        ...
                        <div class="button-wrap btn btn-item">
                            <input class="step-action custom-button custom-button_blue" type="submit"
                                       name="efbf_submit"
                                       value="SAVE AND CONTINUE TO NEXT"/>
...
<!--/home/c/cok23/caytex.ru/public_html/stream/form/assets-and-liabilities
/home/c/cok23/caytex.ru/public_html/stream/form/borrower-information
/home/c/cok23/caytex.ru/public_html/stream/form/declarations
/home/c/cok23/caytex.ru/public_html/stream/form/employment-information
/home/c/cok23/caytex.ru/public_html/stream/form/government-information
/home/c/cok23/caytex.ru/public_html/stream/form/income-information
/home/c/cok23/caytex.ru/public_html/stream/form/loan-property-information
/home/c/cok23/caytex.ru/public_html/stream/form/type-of-mortgage-and-terms-of-loan-->
