...
if ($arParams['IBLOCK_ELEMENT_ID']) {
    ...
    $elemIdTpl = $arParams['IBLOCK_ELEMENT_ID'];
}
?>
...
<div class="feedback" id="feedback<?= $arParams['COMPONENT_ID'] ?>">
            ...
            <? if (is_array($arResult["PROPERTY_LIST"]) && count($arResult["PROPERTY_LIST"] > 0)): ?>
                <div>
                    ...
                    <? foreach ($arResult["PROPERTY_LIST"] as $propertyID): ?>
                        ...
                        <div class="row">
                            <div class="label col-md-4 <?= $arParams['DATA-div-LABEL-ALIGN-H'] ?> <?= $arParams['DATA-div-LABEL-ALIGN-V'] ?>">
                                <?
                            ...
                            <div class="data col-md-8" id="<?= $propertyID ?>">
                                    ...
                                    <?
                                        ...
                                        <? if ($propertyID == 'PROP_ID_ELEMENT'): ?>
                                            ...
                                            if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["USER_TYPE"] == "DateTime"):?>datetime<? endif ?>"
                                                   ...
                                                   size="25"
                                                   value="<?= $elemIdTpl ?>"/>
                                        <?elseif($propertyID == 'PROP_DRIVER_BANK_BIK'):?>
                                            <input onblur="onBank(this);" id="<?= $propertyID . '_' . $i ?>" class="inputtext form-control <?
                                            if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["USER_TYPE"] == "DateTime"):?>datetime<? endif ?>"
                                                   type="text" name="PROPERTY[<?= $propertyID ?>][<?= $i ?>]" size="25"
                                                   value="<?= $value ?>"/>
                    ...
                    <? if ($arParams["USE_CAPTCHA"] == "Y" && !$USER->IsAuthorized()): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="data" id="CAPTCHA">
                                <div class="wrapper">
                                    <input class="inputtext form-control" type="text" name="captcha_word" maxlength="50"
                                           value="">
                ...
                <div class="row">
                    <div class="submit-td">
                        <div class="button-wrap btn1 btn1-item">
                            <input class="button btn1 btn1-item-inner" type="submit" name="efbf_submit"
                                   value="<?= GetMessage("CT_EFBF_FORM_SUBMIT") ?>"/>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <style type="text/css">
        ...
        <?if($arParams['EFBF_FORM_WIDTH']):?> width: <?=$arParams['EFBF_FORM_WIDTH']?>;
        <?endif?>
        }
    </style>
</div>
